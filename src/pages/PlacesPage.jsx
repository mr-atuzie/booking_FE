      ...
      {action === "new" && (
        <div>
          <form>
            ...
            <p className=" text-gray-500 text-xs lgtext-sm ">
            ...
            <p className=" text-gray-500 text-xs lgtext-sm">more is better</p>
            ...
            <div className=" grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 mt-2">
              <button className="flex items-center justify-center text-sm border bg-transparent rounded-2xl p-8 gap-1  text-gray-600">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
